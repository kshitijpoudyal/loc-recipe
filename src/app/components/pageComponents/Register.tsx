        ...
        <div className="w-full max-w-[1440px] min-h-screen md:min-h-[800px] bg-surface-container-low md:rounded-xl overflow-hidden flex flex-col md:flex-row md:shadow-2xl md:shadow-on-surface/5">
            ...
            <section className="relative hidden md:flex md:w-1/2 lg:w-3/5 items-center justify-center overflow-hidden bg-surface-container-highest">
                <div className="absolute inset-0">
                    ...
                    <img src={FOOD_IMAGE} alt="Gourmet dish" className="w-full h-full object-cover"/>
                ...
                <div className="relative z-10 p-10 rounded-xl max-w-md mx-8 border border-white/20"
                    ...
                    <p className="font-headline text-xl italic text-on-surface/80 leading-relaxed">
                        &quot;Every great chef began with a single recipe. Start writing yours today.&quot;
                    </p>
            ...
            <section className="w-full md:w-1/2 lg:w-2/5 bg-surface-container-lowest flex flex-col justify-center px-8 md:px-16 lg:px-24 py-12 relative min-h-screen md:min-h-0">
                ...
                <div className="mb-10">
                    <h2 className="font-headline text-3xl text-on-surface mb-2">Begin Your Journey</h2>
                    <p className="text-on-surface/60 font-body">Create your account and start curating your collection.</p>
                </div>
                ...
                <button
                    ...
                    disabled={loading}
                    className="w-full flex items-center justify-center gap-3 py-3 px-4 border border-outline-variant/20 rounded-lg hover:bg-surface-container-low transition-colors font-body text-sm font-medium disabled:opacity-60 mb-8"
                >
                ...
                <div className="flex items-center gap-4 mb-8">
                    ...
                    <span className="font-label text-xs uppercase tracking-widest text-on-surface/40">or with email</span>
                    <div className="h-px flex-1 bg-outline-variant/30"/>
                </div>

                <form onSubmit={handleRegister} className="space-y-5">
                    <div className="space-y-2">
                        <label htmlFor="displayName" className="font-label text-sm font-semibold uppercase tracking-wider text-on-surface/70 block">
                            Full Name
                        </label>
                        <input
                            id="displayName"
                    ...
                    <div className="space-y-2">
                        <label htmlFor="confirmPassword" className="font-label text-sm font-semibold uppercase tracking-wider text-on-surface/70 block">
                            Confirm Password
                        </label>
                        <input
                            id="confirmPassword"
                            ...
                            placeholder="••••••••"
                            className={`w-full bg-surface-container-low border-none rounded-lg py-4 px-4 text-on-surface placeholder:text-on-surface/30 focus:ring-2 transition-all outline-none ${
                                confirmPassword && confirmPassword !== password
                                    ? 'focus:ring-error/20 ring-2 ring-error/30'
                    ...
                    <button
                        type="submit"
                        disabled={loading}
                        className={`w-full hero-gradient text-on-primary font-label font-semibold py-4 rounded-full shadow-lg shadow-primary/20 hover:opacity-90 active:scale-[0.98] transition-all text-lg mt-2 ${loading ? 'opacity-60 cursor-not-allowed' : ''}`}
                    >
